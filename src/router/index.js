...
},
{
  ...
  children:[
    ...
    },
    {
      path: '/page1',
      name: 'page1',
      component: () => import(/* webpackChunkName: "LSD.bighome" */ '../views/page1/index.vue'),
    }, {
      path: '/page2',
      name: 'page2',
      component: () => import(/* webpackChunkName: "LSD.bighome" */ '../views/page2/index.vue'),
    },
    {
      path: '/page3',
      name: 'page3',
      component: () => import(/* webpackChunkName: "LSD.bighome" */ '../views/page3/index.vue'),
    }
  ]
}, 
];
